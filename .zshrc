...
alias learnom="cd ~/.local/share/omarchy/bin && nvim"
alias c="code ."
alias zz="zed ."
alias j="z"
alias ww="webstorm ."
...
alias bi="pacman -Slq | fzf --preview 'pacman -Si {}' --preview-window=wrap --bind 'enter:execute(sudo pacman -S --noconfirm {})+abort'"
alias br="pacman -Qq | fzf --preview 'pacman -Qi {}' --preview-window=wrap --bind 'enter:execute(sudo pacman -Rns --noconfirm {})+abort'"
alias byi="yay -Slq | fzf --preview 'yay -Si {}' --preview-window=wrap --bind 'enter:execute(sudo yay -S --noconfirm {})+abort'"
alias byr="pacman -Qq | fzf --preview 'pacman -Qi {}' --preview-window=wrap --bind 'enter:execute(sudo pacman -Rns --noconfirm {})+abort'"
